...
export const LOCAL_PROJECTS: PortfolioProject[] = [
  ...
  },
  {
    ...
    summary: "Storefront for a handmade crochet atelier — a three-chapter catalogue, cart, and custom-order enquiry flow.",
    role: "Frontend Engineer",
    stack: ["React", "Vite", "Custom CSS", "Vercel"],
    live_url: "https://the-wool-house.vercel.app",
    repo_url: null,
    cover_image_url: "/app_icons/the_wool_house_icon.jpg",
    featured: true,
    sort_order: 2,
    created_at: "2026-06-24T00:00:00.000Z",
  },
  {
    id: 3,
    slug: "alnoor-cloth-house",
    title: "Al Noor Cloth House",
    summary: "Django-backed ERP with a Flutter frontend for a retail cloth business — Tekroniks' first client engagement.",
    role: "Full Stack Engineer",
    stack: ["Flutter", "Django", "PostgreSQL", "REST APIs"],
    live_url: null,
    repo_url: null,
...
export const LOCAL_SKILLS: PortfolioSkill[] = [
  ...
  { id: 15, category: "Database", name: "PostgreSQL", proficiency: 90, sort_order: 15 },
  { id: 16, category: "Database", name: "MySQL", proficiency: 80, sort_order: 16 },
  { id: 17, category: "Database", name: "MongoDB", proficiency: 80, sort_order: 17 },
];
