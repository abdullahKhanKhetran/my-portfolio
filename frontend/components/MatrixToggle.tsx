...
export default function MatrixToggle({ className = "" }: { className?: string }) {
  ...
  return (
    <button
      ...
      className={`flex h-12 min-w-12 items-center justify-center rounded-tl-[14px] rounded-tr-[999px] rounded-br-[14px] rounded-bl-[999px] bg-white/75 px-3 text-zinc-700 shadow-xl shadow-black/10 backdrop-blur-md transition-transform duration-200 hover:scale-105 ${className}`}
    >
